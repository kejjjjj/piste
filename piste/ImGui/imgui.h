...
namespace COL {
    constexpr ImVec4 BLACK = ImVec4(0, 0, 0, 255);
    constexpr ImVec4 WHITE = ImVec4(255, 255, 255, 255);
    constexpr ImVec4 RED = ImVec4(255, 0, 0, 255);
    constexpr ImVec4 GREEN = ImVec4(0, 255, 0, 255);
    constexpr ImVec4 BLUE = ImVec4(0, 0, 255, 255);
    constexpr ImVec4 CLEAR = ImVec4(255, 255, 255, 0);
