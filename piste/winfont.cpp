...
{
	InsertFont("PixelatedM", (root_directory + "\\fonts\\JetBrainsMono-Bold.ttf"), 40);
	InsertFont("PixelatedSM", (root_directory + "\\fonts\\JetBrainsMono-Bold.ttf"), 20);
	InsertFont("PixelatedL", (root_directory + "\\fonts\\JetBrainsMono-Bold.ttf"), 50);
	InsertFont("PixelatedXL", (root_directory + "\\fonts\\JetBrainsMono-Bold.ttf"), 60);
